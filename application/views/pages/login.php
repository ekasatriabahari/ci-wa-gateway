...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?= base_url('assets/ui/') ?>img/favicon.ico"/>
    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Quicksand:400,500,600,700&display=swap" rel="stylesheet">
    <link href="<?= base_url('assets/ui/') ?>bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="<?= base_url('assets/ui/') ?>css/plugins.css" rel="stylesheet" type="text/css" />
    <link href="<?= base_url('assets/ui/') ?>css/authentication/form-2.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/ui/') ?>css/forms/theme-checkbox-radio.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/ui/') ?>css/forms/switches.css">
</head>
<body class="form">
    ...
    <script src="<?= base_url('assets/ui/') ?>js/authentication/form-2.js"></script>
